...
import { faPlus, faCheck,faXmark ,faEdit, faArrowTurnRight,faEllipsis, faCopy, faTrash, faDownload} from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    <Table>
                                        <thead className='thead-dark '>
                                            ...
                                            <th className='th-w50'>ID</th>
                                                ...
                                                <th className='th-w130'>Invoice number</th>
                                        ...
                                        <tbody>
                                            ...
                                            <td className='td-w50'>188</td>
                                                ...
                                                <td className='td-w100'>4325345
                                                    
                                                    </td>
                                                <td className='td-w100'><span className='unpaid'> Unpaid</span></td>
                                                <td className='td-w130'>43534534646e</td>
                                                <td className='td-w100'>Description</td>
                                                <td className='td-w100'><span className='check'><FontAwesomeIcon icon={faCheck} color="#fff"/> </span></td>
                                                <td className='td-w100'><span className='approved'>Approved</span></td>
                                                <td className='td-w50'>
